...
this pressure variation follows the nucleus-of-strain concept, in which the center of 
each prism represents the coordinate of a nucleus of strain.
...
distribution.
The results obtained for the three scenarios show that the Beltrami's and equilibrium 
equations are satisfied, which means that our method produces null stress field 
